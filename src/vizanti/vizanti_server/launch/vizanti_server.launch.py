...
def generate_launch_description():
    ...
    default_widget_config = launch.substitutions.LaunchConfiguration('default_widget_config', default='/home/mosalam/robot_ws/src/robot/config/vizanti_config.json') #e.g. ~/your_custom_config.json
